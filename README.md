...
## Deploy
Publish these files to GitHub Pages **at the repository root**.
Do NOT nest them in a subfolder — all internal links are relative and will break.
...
## After deploy
Return the live URL. It gets pasted into the Weekly Leader Updates doc
where it currently reads `PASTE_LIVE_URL_HERE`.
